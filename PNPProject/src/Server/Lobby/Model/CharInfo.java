...
public class CharInfo {
    private String name, gender, race, _class, socialStatus, apperance, alingment;
    private long age, weight, height, health, level, xp, mana, adrenalin, stamina, gold;
    ...
    public long getAdrenalin() {
        return adrenalin;
    }

    public void setAdrenalin(long adrenalin) {
